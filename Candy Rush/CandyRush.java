...
public class CandyRush extends JPanel implements Runnable, KeyListener {
	...
	public CandyRush() {
		...
		// Boul label
		boul = new JLabel(new ImageIcon("box.png"));
        ...
        labelName.setBounds(450, 2, 550, 30);
        labelName.setFont(new Font("Georgia", Font.BOLD, 30));
        add(labelName);

		// Score Label
		labelScore = new JLabel("0");
		labelScore.setBounds(getBounds().width - 70, 2, 150, 30);
		labelScore.setFont(new Font("Georgia", Font.BOLD, 30));
		add(labelScore);
